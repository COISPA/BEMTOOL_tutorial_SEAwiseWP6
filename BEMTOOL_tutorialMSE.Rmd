...
Consider that the for parameterizing the fish price functions and the variable costs, a dedicated tutorial was developed [SEAwise – Fish price & Variable costs](https://coispa.github.io/Fish-price-and-variable-costs/Enhanced_fishprice_fuelcosts_submodels.html).
